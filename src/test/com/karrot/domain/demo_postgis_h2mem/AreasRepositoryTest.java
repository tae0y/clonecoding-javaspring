package com.karrot.domain.demo_postgis_h2mem;
...
public class AreasRepositoryTest {
    ...
    public void shouldSaveAreas() {
        ...
        System.out.println("DCVXLJDO >>>> before save area " + area);
        areasRepository.save(area);
        System.out.println("DCVXLJDO >>>> after save area " + area);

        entityManager.persistAndFlush(area);

        System.out.println("DCVXLJDO > area list " + areasRepository.findAll());
